...
<body>
    ...
    <main>
        <section>
            <h2 align="center">Successfully  Added to Cart!</h2>
            <a href="cart.php"><button class="center">View Cart</button></a>
            <a href="index.php"><button class="center">Continue Browsing Products</button></a>
        </section>
    </main>
    <footer>
